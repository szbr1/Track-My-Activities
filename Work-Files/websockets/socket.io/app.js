...
// using connection and console it run each time whenever new user connects with the server 
...
io.on("connection", (socket)=>{           //                               <== Connection
    ...
    // Befor we had send the data know we will recieve the data from client that client  emit to us 
